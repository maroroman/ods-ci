...
Does show full disk warning
  ...
  Input Text  //div[.="Clone a repo"]/../div[contains(@class, "jp-Dialog-body")]//input  https://github.com/redhat-rhods-qe/ods-ci-notebooks-main
  Click Element  xpath://div[.="CLONE"]
  Sleep  1
  Open With JupyterLab Menu  File  Open from Path…
  Wait Until Page Contains    Open Path   timeout=30
  Input Text  xpath=//input[@placeholder="/path/relative/to/jlab/root"]  ods-ci-notebooks-main/notebooks/200__monitor_and_manage/203__alerts/notebook-pvc-usage/fhttps://github.com/redhat-rhods-qe/ods-ci-notebooks-main/blob/main/notebooks/200__monitor_and_manage/203__alerts/notebook-pvc-usage/fill-notebook-pvc-to-100.ipynb
